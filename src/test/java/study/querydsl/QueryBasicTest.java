...
public class QueryBasicTest {
    ...
    public void findDtoBySetter(){
        List<MemberDto> result = queryFactory
                //bean() getter, setter 세터로 데이터를 인젝션 해준다.
                //MemberDto.class 타입 지정해줘야 함
    ...
    private List<Member> searchMember1(String usernameCond, Integer ageCond){
        ...
        // null이 아니면 builder에 and조건을 넣을 수 있다.
        // 둘 다 null이면 동작을 안 하지만, 하나만 있으면 하나만 들어간다.
    ...
    // 동적 쿼리로 메서드를 만들면 조합이 가능해진다.
    // 자바 코드기 때문에 기존에 sql 마이버티스에선 불가능했던 것이 가능해진다.
